...
extension GarageHomeVC {
    ...
    private func dataSetUp(){
        ...
        self.dataArray = [GarageDataValue(requestCount: self.viewModel.garageHomeModel.acceptedRequets, revenue: 0.0, name: LocalizedString.requestAccepted.localized,requestColor: UIColor(r: 6, g: 130, b: 191, alpha: 1.0),backgroundColor: UIColor(r: 230, g: 240, b: 245, alpha: 1.0) ),
                          ...
                          GarageDataValue(requestCount: 0, revenue: self.viewModel.garageHomeModel.revenue, name:LocalizedString.today_Revenue.localized,requestColor: UIColor(r: 44, g: 182, b: 16, alpha: 1.0),backgroundColor: UIColor(r: 239 , g: 246, b: 231, alpha: 1.0))]
    }
...
extension GarageHomeVC:  GarageHomeVMDelegate{
    ...
    func getGarageHomeDataSuccess(msg: String) {
        self.dataArray = [GarageDataValue(requestCount: self.viewModel.garageHomeModel.acceptedRequets, revenue: 0.0, name: LocalizedString.requestAccepted.localized,requestColor: UIColor(r: 6, g: 130, b: 191, alpha: 1.0),backgroundColor: UIColor(r: 230, g: 240, b: 245, alpha: 1.0) ),
                          ...
                          GarageDataValue(requestCount: 0, revenue: self.viewModel.garageHomeModel.revenue, name: LocalizedString.today_Revenue.localized,requestColor: UIColor(r: 216, g: 91, b: 134, alpha: 1.0),backgroundColor: UIColor(r: 253 , g: 219, b: 219, alpha: 1.0))]
