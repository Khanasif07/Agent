...
class SRFliterVM {
    ...
    func initialData() {
        let catModel = CatModel(subCat: [SubCatModel(name: "Bid Finalized"),SubCatModel(name: "Tyre Service"),SubCatModel(name: "Oil Sevice"),SubCatModel(name: "Battery Service"),SubCatModel(name: "Battery"),SubCatModel(name: "Battery Service")], isSelected: false, name: "By Service Type")
